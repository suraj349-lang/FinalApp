...
@Composable
fun GetDroppedProfiles(navController:NavHostController,offerViewModel:OfferViewModel) {
    ...
    val predictions by offerViewModel.getAutocompletePredictions(query).collectAsState(emptyList())
