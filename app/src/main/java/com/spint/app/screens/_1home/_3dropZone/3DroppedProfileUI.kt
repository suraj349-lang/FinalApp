package com.spint.app.screens._1home._3dropZone
...
fun DroppedProfilesUI(
    ...
    Surface(modifier = Modifier
        ...
        if(showDialog){
            LocationAndNameSearchDialogBox(name,{name=it},query,{query=it},predictions, onDismiss = {showDialog=false}) {
                homeViewModel.getDefaultDropProfiles(query)
            }
        }
    }
}
...
@Composable
fun LocationAndNameSearchDialogBox(
    name: String,
